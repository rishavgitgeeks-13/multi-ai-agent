...
"""
    ...
    def _stat_context_rules() -> str:
        return (
            ...
            "never a generic 'Contact Property Advisor' when writing for a named brand.\n"
            "- HASHTAGS: For articles/blogs, do NOT add a 'Hashtags:' footer — packaging "
            "adds hashtags once. Never output two Hashtags blocks."
        )
...
"""
    ...
    def _format_editorial_intent(cls, additional_instructions: str) -> str:
        ...
        return (
            ...
            "- If hashtags are listed for social posts, include them once at the end. "
            "For articles/blogs, do NOT add a Hashtags: footer (packaging adds it).\n"
